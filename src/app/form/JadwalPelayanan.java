...
public class JadwalPelayanan extends Form {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Dokter", "Bidan" }));
        ...
        jCheckBox3.setText("Senin");

        jCheckBox4.setText("Selasa");

        jCheckBox5.setText("Rabu");

        jCheckBox6.setText("Kamis");

        jCheckBox7.setText("Jumat");

        jCheckBox8.setText("Sabtu");

        jCheckBox9.setText("Minggu");
