...
import app.blankchart.BlankPlotChart;
import app.blankchart.BlankPlotChatRender;
import app.blankchart.SeriesSize;
...
public class CurveChart extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        blankPlotChart = new app.blankchart.BlankPlotChart();
        panelLegend = new javax.swing.JPanel();

        setBackground(new java.awt.Color(255, 255, 255));

        blankPlotChart.setForeground(new java.awt.Color(80, 80, 80));
    ...
    private app.blankchart.BlankPlotChart blankPlotChart;
